            ...
            <div class="row flex-lg-nowrap">
                ...
                <div class="col-9">
                    ...
                    <nav aria-label="Page navigation example">
                        ...
                        <ul class="pagination">
                            <li class="page-item">
                                <a class="page-link" href="ProductAdminController?page=${currentPage-1}" aria-label="Previous">
                            ...
                            <li class="page-item">
                                <a class="page-link" href="ProductAdminController?page=${i+1}" aria-label="Next">
