                                        ...
                                        <c:forEach items="${sessionScope.cart2}" var="p">	
                                            <div class="product">
                                                <div class="row justify-content-center align-items-center">
                                                    ...
                                                    <div class="col-6 col-md-1 "><button style="height:3rem;width: 5rem; margin-left: 1rem; " type="button" onclick="showMess('${p.getKey().getMa()}')" class="btn btn-danger">Xóa</button></div>
